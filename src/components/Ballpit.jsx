...
class x {
  ...
  dispose() {
    ...
    // Do not call forceContextLoss() as it can prevent subsequent context recreation on double-mount or Fast Refresh.
    ...
    return () => {
      if (spheresInstanceRef.current) {
        try {
          ...
          console.error("Error during Ballpit disposal:", e);
        }
      }
    };
